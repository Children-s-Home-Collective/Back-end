...
def seed_database():
    ...
    # Seed Children Homes
    homes = [
        ChildrenHome(id=1, name='Upendo Children’s Home', location='Westlands, Nairobi', phone_number='+254720123456', email='upendo.naivasha@egmail.com', description='A nurturing home for children in Nairobi’s Westlands area.', created_at=datetime.now(timezone.utc)),
        ChildrenHome(id=2, name='Tumaini Orphanage', location='Kilimani, Nairobi', phone_number='+254721234567', email='tumaini.nakuru@gmail.com', description='Providing hope and education in Kilimani.', created_at=datetime.now(timezone.utc)),
        ChildrenHome(id=3, name='Neema Children’s Home', location='Kisumu City, Kisumu', phone_number='+254722345678', email='neema.nairobi@gmail.com', description='Empowering children in Kisumu with care and education.', created_at=datetime.now(timezone.utc)),
        ChildrenHome(id=4, name='Amani Shelter', location='Eldoret Town, Uasin Gishu', phone_number='+254723456789', email='amani.naivasha@gmail.com', description='A safe haven for children in Eldoret.', created_at=datetime.now(timezone.utc)),
        ChildrenHome(id=5, name='Baraka Home', location='Nakuru City, Nakuru', phone_number='+254724567890', email='baraka.naks@gmail.com', description='Fostering growth and community in Nakuru.', created_at=datetime.now(timezone.utc)),
        ChildrenHome(id=6, name='Furaha Orphanage', location='Thika Town, Kiambu', phone_number='+254725678901', email='furaha.thikaroad@gmail.com', description='Bringing joy to children in Thika.', created_at=datetime.now(timezone.utc)),
        ChildrenHome(id=7, name='Imani House', location='Nyeri Town, Nyeri', phone_number='+254726789012', email='imani.nyeritown@gmail.com', description='A caring community for children in Nyeri.', created_at=datetime.now(timezone.utc)),
        ChildrenHome(id=8, name='Jua Kali Home', location='Kakamega Town, Kakamega', phone_number='+254727890123', email='juakali.kakamegamills@gmail.com', description='Supporting children’s dreams in Kakamega.', created_at=datetime.now(timezone.utc))
    ]
    ...
    # Seed Photos
    photos = [
        Photo(id=1, image_url="https://images.unsplash.com/photo-1585459503122-ca4fb244c33c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzF8fHNpbXBsZSUyMGhvdXNlcyUyMHRoYXQlMjBjYW4lMjBob2xkJTIwMTclMjBwZW9wbGV8ZW58MHx8MHx8fDA%3D", children_home_id=1),
        Photo(id=2, image_url="https://images.unsplash.com/photo-1694286068274-1058e6b04dcc?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTE5fHxraWRzJTIwZ2F0aGVyaW5nfGVufDB8fDB8fHww", children_home_id=1),
        Photo(id=3, image_url="https://plus.unsplash.com/premium_photo-1685118419397-c8ed456734ec?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTN8fHNtYWxsJTIwc3BvcnRzJTIwZ3JvdW5kc3xlbnwwfHwwfHx8MA%3D%3D", children_home_id=1),
        Photo(id=4, image_url="https://images.unsplash.com/photo-1635193503553-0678ca1d8582?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODh8fHNjaG9vbCUyMGJlZCUyMGFyZWFzfGVufDB8fDB8fHww", children_home_id=1),
        Photo(id=5, image_url="https://plus.unsplash.com/premium_photo-1722593856418-05d6d47eec59?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzd8fHNpbXBsZSUyMGhvdXNlcyUyMHRoYXQlMjBjYW4lMjBob2xkJTIwMTclMjBwZW9wbGV8ZW58MHx8MHx8fDA%3D", children_home_id=2),
        Photo(id=6, image_url="https://images.unsplash.com/photo-1611183110451-7e156d15581d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTkyfHxraWRzJTIwZ2F0aGVyaW5nLi4ucHJlZmVycmFibHklMjBvZiUyMGFsbCUyMHJhY2VzfGVufDB8fDB8fHww", children_home_id=2),
        Photo(id=7, image_url="https://images.unsplash.com/photo-1655936072812-a55302b986e0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHNtYWxsJTIwc3BvcnRzJTIwZ3JvdW5kc3xlbnwwfHwwfHx8MA%3D%3D", children_home_id=2),
        Photo(id=8, image_url="https://plus.unsplash.com/premium_photo-1677567996070-68fa4181775a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8bGlicmFyeXxlbnwwfHwwfHx8MA%3D%3D", children_home_id=2),
        Photo(id=9, image_url="https://images.unsplash.com/photo-1569017437456-a82e38aea5ed?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDd8fHNpbXBsZSUyMGhvdXNlcyUyMHRoYXQlMjBjYW4lMjBob2xkJTIwMTclMjBwZW9wbGV8ZW58MHx8MHx8fDA%3D", children_home_id=3),
        Photo(id=10, image_url="https://images.unsplash.com/photo-1695131494906-91f5433f1804?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTcwfHxraWRzJTIwZ2F0aGVyaW5nLi4ucHJlZmVycmFibHklMjBvZiUyMGFsbCUyMHJhY2VzfGVufDB8fDB8fHww", children_home_id=3),
        Photo(id=11, image_url="https://images.unsplash.com/photo-1552817446-9943ef873b77?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fHNtYWxsJTIwc3BvcnRzJTIwZ3JvdW5kc3xlbnwwfHwwfHx8MA%3D%3D", children_home_id=3),
        Photo(id=12, image_url="https://images.unsplash.com/photo-1549856625-b119eef82aa6?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjN8fHNjaG9vbCUyMGJlZCUyMGFyZWFzfGVufDB8fDB8fHww", children_home_id=3),
        Photo(id=13, image_url="https://images.unsplash.com/photo-1655708553278-f449851bb703?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODZ8fHNpbXBsZSUyMGhvdXNlcyUyMHRoYXQlMjBjYW4lMjBob2xkJTIwMTclMjBwZW9wbGV8ZW58MHx8MHx8fDA%3D", children_home_id=4),
        Photo(id=14, image_url="https://images.unsplash.com/photo-1603998382124-c9835bf50409?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDJ8fGtpZHMlMjBnYXRoZXJpbmcuLi5wcmVmZXJyYWJseSUyMG9mJTIwYWxsJTIwcmFjZXN8ZW58MHx8MHx8fDA%3D", children_home_id=4),
        Photo(id=15, image_url="https://images.unsplash.com/photo-1540827563097-a6b8abab0a71?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8c21hbGwlMjBzcG9ydHMlMjBncm91bmRzfGVufDB8fDB8fHww", children_home_id=4),
        Photo(id=16, image_url="https://images.unsplash.com/photo-1724093834407-da3e0fcb7c9d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzF8fHNjaG9vbCUyMGJlZCUyMGFyZWFzfGVufDB8fDB8fHww", children_home_id=4),
        Photo(id=17, image_url="https://images.unsplash.com/photo-1574259392081-dbe3c19cd15e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTEyfHxzaW1wbGUlMjBob3VzZXMlMjB0aGF0JTIwY2FuJTIwaG9sZCUyMDE3JTIwcGVvcGxlfGVufDB8fDB8fHww", children_home_id=5),
        Photo(id=18, image_url="https://images.unsplash.com/photo-1567727834061-354b65cf0633?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzR8fGtpZHMlMjBnYXRoZXJpbmcuLi5wcmVmZXJyYWJseSUyMG9mJTIwYWxsJTIwcmFjZXN8ZW58MHx8MHx8fDA%3D", children_home_id=5),
        Photo(id=19, image_url="https://images.unsplash.com/photo-1721886537583-ea3a257adb9e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHNwb3J0JTIwZmFjaWxpdGllc3xlbnwwfHwwfHx8MA%3D%3D", children_home_id=5),
        Photo(id=20, image_url="https://plus.unsplash.com/premium_photo-1703701579680-3b4c2761aa47?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjF8fGxpYnJhcnl8ZW58MHx8MHx8fDA%3D", children_home_id=5),
        Photo(id=21, image_url="https://images.unsplash.com/photo-1579031711062-85b3f2d92e8b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTMzfHxzaW1wbGUlMjBob3VzZXMlMjB0aGF0JTIwY2FuJTIwaG9sZCUyMDE3JTIwcGVvcGxlfGVufDB8fDB8fHww", children_home_id=6),
        Photo(id=22, image_url="https://images.unsplash.com/photo-1509099836639-18ba1795216d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGtpZHMlMjBnYXRoZXJpbmcuLi5wcmVmZXJyYWJseSUyMG9mJTIwYWxsJTIwcmFjZXN8ZW58MHx8MHx8fDA%3D", children_home_id=6),
        Photo(id=23, image_url="https://plus.unsplash.com/premium_photo-1665673313512-9ea6c83b8c84?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nzd8fHNtYWxsJTIwc3BvcnRzJTIwZ3JvdW5kc3xlbnwwfHwwfHx8MA%3D%3D", children_home_id=6),
        ...
        Photo(id=25, image_url="https://images.unsplash.com/photo-1652274409871-96ca9c036f80?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjY5fHxzaW1wbGUlMjBob3VzZXMlMjB0aGF0JTIwY2FuJTIwaG9sZCUyMDE3JTIwcGVvcGxlfGVufDB8fDB8fHww", children_home_id=7),
        Photo(id=26, image_url="https://images.unsplash.com/photo-1548102268-3d7dc56b01e1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fGtpZHMlMjBnYXRoZXJpbmcuLi5wcmVmZXJyYWJseSUyMG9mJTIwYWxsJTIwcmFjZXN8ZW58MHx8MHx8fDA%3D", children_home_id=7),
        Photo(id=27, image_url="https://images.unsplash.com/photo-1568478624365-1134fbd7c895?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fHNtYWxsJTIwc3BvcnRzJTIwZ3JvdW5kc3xlbnwwfHwwfHx8MA%3D%3D", children_home_id=7),
        Photo(id=28, image_url="https://images.unsplash.com/photo-1680798790034-63f18ce5f9bd?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzZ8fGRpbmluZyUyMGFyZWFzJTIwaW4lMjBzY2hvbHN8ZW58MHx8MHx8fDA%3D", children_home_id=7),
        Photo(id=29, image_url="https://images.unsplash.com/photo-1567683740738-d1fbf876b70a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTg1fHxzaW1wbGUlMjBob3VzZXMlMjB0aGF0JTIwY2FuJTIwaG9sZCUyMDE3JTIwcGVvcGxlfGVufDB8fDB8fHww", children_home_id=8),
        Photo(id=30, image_url="https://images.unsplash.com/photo-1642420290986-c7a55bab708f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8a2lkcyUyMGdhdGhlcmluZy4uLnByZWZlcnJhYmx5JTIwb2YlMjBhbGwlMjByYWNlc3xlbnwwfHwwfHx8MA%3D%3D", children_home_id=8),
        Photo(id=31, image_url="https://images.unsplash.com/photo-1548221605-b119eef82aa6?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OTZ8fHNtYWxsJTIwc3BvcnRzJTIwZ3JvdW5kc3xlbnwwfHwwfHx8MA%3D%3D", children_home_id=8),
        Photo(id=32, image_url="https://images.unsplash.com/photo-1493666835815-de6b83927e24?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8ZGluaW5nJTIwYXJlYXMlMjBpbiUyMHNjaG9sc3xlbnwwfHwwfHx8MA%3D%3D", children_home_id=8)
    ]
